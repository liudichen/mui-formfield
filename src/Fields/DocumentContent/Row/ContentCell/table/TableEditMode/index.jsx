    ...
    <Box>
      <Box>
        <TextField
          ...
          InputProps={{
            startAdornment: <InputAdornment position="start">表</InputAdornment>,
          ...
          InputProps={{
            endAdornment: table.text ? (
              <InputAdornment position="end">
                <IconButton tabIndex={-1} sx={{ ml: -0.5 }} onClick={() => onTitleChange()}>
                  <IconX size="20px" />
                </IconButton>
              </InputAdornment>
            ) : null,
        ...
        {inputType === 'input' && (
          <Box>
            <TextField
              ...
              InputProps={{
                startAdornment: <InputAdornment position="start">表格共:</InputAdornment>,
                endAdornment: <InputAdornment position="end">列:</InputAdornment>,
              }}
              sx={{ width: 130 }}
            />
          </Box>
      ...
      {inputType === 'input' && !!table?.tableCols && (
        <Box>
          <Alert severity="info">注意:第1行应为表头</Alert>
          <EditableTable
            rowKey="id"
            editMode="row"
            showAddRow
